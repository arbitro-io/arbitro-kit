//! RING_CAP sweep for gate::Mpmc. Tests 16 / 64 / 256 / 1024 on the most
//! informative shapes to see where returns diminish.
//!
//! bench_safety: BATCH=1000, rounds capped, timeout+tee expected.
    ...
    for p in ps.into_iter() {
        ...
        hs.push(thread::spawn(move || {
            ...
            loop {
                ...
                for k in 0..per as u64 { p.send(k); }
